...
export def GetTreeWindowHelp(): list<dict<any>>
    return [
        ...
        FormatHelp('go to top',              g:poplar.keys.GO_TO_TOP),
        FormatHelp('go to bottom',           g:poplar.keys.GO_TO_BOTTOM),
        ...
        FormatHelp('open with :Open',        g:poplar.keys.TREE_OPEN_SYS),
...
export def GetPinWindowHelp(): list<dict<any>>
    return [
        ...
        FormatHelp('open with :Open',     g:poplar.keys.PIN_OPEN_SYS),
